#easy data set - nonoverlapping peptides (only first and last aa)
...
system.time(res <- pblapply(1L:4, function(repetition) {
...
save(res, file = paste0(pathway, "build_cleave_nonoverlapping.RData"))